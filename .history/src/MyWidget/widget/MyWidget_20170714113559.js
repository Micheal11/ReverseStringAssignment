...
define([
    ...
    return declare("MyWidget.widget.MyWidget", [ _WidgetBase, _TemplatedMixin ], {
        ...
        reversedString: function (strRev) {
	    var myString = strRev.split(""); 
	    var reverseMyString = myString.reverse();
	    var reversed = reverseMyString.join(""); 
	    return document.writeln(reversed); 
        },
