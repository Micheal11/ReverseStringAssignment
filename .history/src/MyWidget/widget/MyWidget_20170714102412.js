...
define([
    ...
    return declare("MyWidget.widget.MyWidget", [ _WidgetBase, _TemplatedMixin ], {
        ...
        changeme: function(){
           // this.infoTextNode.innerHTML = ":"+this.ss.value;
            //this.infoTextNode.innerHTML = ":"+reversedString(this.ss.value);
        ...
        reversedString: function () {
             var strr = this.ss.innerHTML;  
             myString = strr.split(""); 
             reverseMyString = myString.reverse();
          this.infoTextNode.innerHTML = reverseMyString.join(""); 
