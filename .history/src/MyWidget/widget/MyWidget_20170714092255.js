...
define([
    ...
    return declare("MyWidget.widget.MyWidget", [ _WidgetBase, _TemplatedMixin ], {
        ...
        changeme: function(){
            var rs = this.ss.value+"";
            rs = reversedString(rs);

            this.infoTextNode.innerHTML = "button works"+rs;
           //  this.infoTextNode.innerHTML = "button works:"+reversedString( this.ss.value);
        },
        ...
        reversedString: function (str) {
            logger.debug(this.id + ".rev")
             myString = str.split(""); 
             reverseMyString = myString.reverse();
            return( reversed = reverseMyString.join("")); 
